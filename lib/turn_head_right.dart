...
class TurnHeadRightPage extends StatefulWidget {
  const TurnHeadRightPage({super.key});

  @override
  _TurnHeadRightPageState createState() => _TurnHeadRightPageState();
}

class _TurnHeadRightPageState extends State<TurnHeadRightPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("تحقق من الهوية - لف الرأس لليمين"),
